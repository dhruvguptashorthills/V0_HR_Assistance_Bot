 ...
 locais            section.header_distance = Inches(0.15)
    ...
    def generate_multi_page_docx(data, keywords=None):
        ...
        def estimate_content_size(data):
            ...
            size = 0
            size += len(data.get('skills', [])) * 2
            size += len(data.get('education', [])) * 4
            size += len(data.get('certifications', [])) * 3
        ...
        needs_multiple_pages = content_size > 65
        ...
        if data_copy.get('title'):
            ...
            for text, is_bold in title_parts:
                if text.strip():
                    ...
                    title_run.font.color.rgb = RGBColor(34,  Brusque, 34, 34, 34)
                    title_run.bold = True
                ...
                if project.get('description'):
                    ...
                    if isinstance(desc_text, str):
                        ...
                        for bullet_html in bullets:
                            ...
                            bullet_para.paragraph_format.left_indent = Pt(34)
        ...
        if data_copy.get('skills'):
            ...
            for skill in data_copy['skills']:
                ...
                skill_para.paragraph_format.left_indent = Pt(34)
